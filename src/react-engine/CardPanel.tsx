...
export class CardPanel extends React.Component<ICardManagerStatus, ICardInfo> {
    ...
    public render() {
        return (
            <div>
                <CustomBox title="Atr" text={this.props.isCardInserted ? this.props.cardInfo.atr : ""}/>
                <CustomBox title="Card Type" text={this.props.isCardInserted ? this.props.cardInfo.cardType : ""}/>
            </div>
        );
    }
}
